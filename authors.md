...
- **[Dafnis Batallé](https://orcid.org/0000-0003-2097-979X)**. Author.
  [](https://orcid.org/0000-0003-2097-979X)

## Citation

Source:
[`DESCRIPTION`](https://github.com/circadia-bio/dynR/blob/v0.1.4/DESCRIPTION)

França L, Leocadio-Miguel M, Batallé D (2026). *dynR: Dynamic
Connectivity Analysis for Neurophysiological Timeseries*. R package
version 0.1.4, <https://dynr.circadia-lab.uk>.
